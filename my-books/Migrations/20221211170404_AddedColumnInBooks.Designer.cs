...
namespace mybooks.Migrations
{
    ...
    [Migration("20221211170404_AddedColumnInBooks")]
    partial class AddedColumnInBooks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("my_books.Data.Publisher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("my_books.Data.Models.Book", b =>
                {
                    b.HasOne("my_books.Data.Publisher", "Publisher")
                        .WithMany("Books")
